    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                Console.WriteLine("Okay, here is a list of our activites. Please choose one.");
                foreach (string activity in activities)
                {
                    Console.Write($"{activity} ");
                    Thread.Sleep(250);
                ...
                if (userAge < 21 && response == "wine tasting")
                {
                    Console.WriteLine($"Oh no! Looks like you are too young to do {response}");
                    Console.WriteLine("Pick something else!");
                ...
                Console.WriteLine($"Ah got it! {userName}, your chosen activity is {response}. Have all of the fun!");
            }
